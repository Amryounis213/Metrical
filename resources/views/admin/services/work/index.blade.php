    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">View Work-premit Requests </h5>
                <!--end::Title-->
                <!--begin::Separator-->
        ...
        @foreach($workpermit as $service)
            ...
            <div class="card card-custom gutter-b">
                <div class="card-body">
                    <div class="d-flex">
                        <!--begin::Pic-->
                        @if ($service->user->image_url == null)
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        <a href="{{route('ShowFullRequest' , [$service->id , 'work-premit'])}}" class="btn btn-info btn-sm font-weight-bolder text-uppercase ">
