                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                ...
                                <div class="card-toolbar">
                                    <!--begin::Button-->
                                    <a href="{{route('moveIns.create')}}" class="btn btn-primary font-weight-bolder">
                                    ...
                                    <table class="table table-head-custom table-vertical-center"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pl-0">
                                                    <a href="#"
                                                        class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$moveIn->id}}</a>
                                                </td>

                                                <td>
                                                    <span
                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$moveIn->full_name}}</span>
                                                ...
                                                <td class="pr-0 text-right">
                                                    ...
                                                    <a href="{{route('moveIns.edit' ,$moveIn->id)}}"
                                                    ...
                                                    <a class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                        <form action="{{ route('moveIns.destroy', $moveIn->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
													...
													<a class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                        <form action="{{ route('offers.accept', $moveIn->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('put')
                                                            <button type="submit" style="border:none">
