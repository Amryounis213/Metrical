                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div
                                                    ...
                                                    <div class="my-lg-0 my-1">
                                                        <!-- Modal-->
                                                        <button
                                                            class="btn btn-light-success font-weight-bolder btn-sm mr-2"
                                                            id="kt_subheader_group_actions_fetch{{ $service->id }}"
                                                            data-toggle="modal"
                                                            data-target="#exampleModalScrollable{{ $service->id }}">Fetch
                                                            Selected</button>

                                                        <div class="modal fade"
                                                            id="exampleModalScrollable{{ $service->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable"
                                                                ...
                                                                <div class="modal-content">
                                                                        ...
                                                                        <div class="container">
                                                                            <div class="row"
                                                                                ...
                                                                                <div style="margin-bottom: 50px;">
                                                                                    <p>Title Dead</p>
                                                                                    <img src="{{ asset('uploads/' . $service->title_dead) }}"
                                                                                        style=" max-width:100%" alt="">

                                                                                </div>
                                                                                <div style="margin-bottom: 50px;">
                                                                                    <p>Emirlated ID</p>
                                                                                    <img src="{{ asset('uploads/' . $service->emirateId_image) }}"
                                                                                        style=" max-width:100%" alt="">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('accept-movein', $service->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('put')
                                                                            <button type="submit"
                                                                                class="btn btn-primary font-weight-bold">Accept</button>
                                                                        </form>
                                                                        <form
                                                                            action="{{ route('refuse-movein', $service->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('put')
                                                                            <button type="submit"
                                                                                class="btn btn-primary font-weight-bold">Refuse</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="progress progress-xs mt-2 mb-2">
                                                                <div class="progress-bar bg-success" role="progressbar"
                                                                    style="width: 63%;" aria-valuenow="50"
