                                    ...
                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pl-0">
                                                    <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$new->id}}</a>
                                                </td>
                                                <td>
                                                    <span style="border-radius: 3px;" class="text-dark-75 font-weight-bolder d-block font-size-lg"><img style="width: 80px; height:60px; overflow:hidden;" src="{{ asset('uploads/' . $new->image_url)}}" alt=""></span>

                                                </td>
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$new->title_en}}</span>

                                                </td>
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$new->title_gr}}</span>

                                                </td>
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$new->title_ar}}</span>
                                                ...
                                                <td class="pr-0 text-right">
                                                    ...
                                                    <a href="{{route('news.edit' ,$new->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                        <span class="svg-icon svg-icon-md svg-icon-primary">
