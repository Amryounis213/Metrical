                            ...
                            <form class="form" action="{{ route('news.update', $new->id)}}" method="POST"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-empty image-input-outline"
                                                ...
                                                <label
                                                    ...
                                                    <input name="image" type="file" name="profile_avatar"
                                                        accept=".png, .jpg, .jpeg" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-2 col-form-label">Photos</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-empty image-input-outline"
                                                id="kt_image_4"
                                                ...
                                                <label
                                                    ...
                                                    data-original-title="Change avatar">
                                                    <i class="fa fa-pen icon-sm text-muted"></i>
                                                    <input name="photos[]" multiple type="file" name="profile_avatar"
                                                        accept=".png, .jpg, .jpeg" />
                                                    <input type="hidden" name="profile_avatar_remove" />
                                                </label>
                                                <span
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input id="kt_maxlength_1" name="title_ar" class="form-control" type="text"
                                                maxlength="25" value="{{ $new->title_ar }}" id="example-text-input" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input id="kt_maxlength_1" name="title_en" class="form-control" type="text"
                                                maxlength="25" value="{{ $new->title_en }}" id="example-text-input" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input id="kt_maxlength_1" name="title_gr" class="form-control" type="text"
                                                maxlength="25" value="{{ $new->title_gr }}" id="example-text-input" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input id="kt_maxlength_1" name="description_ar" class="form-control"
                                                type="text" maxlength="25" value="{{ $new->description_ar }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input id="kt_maxlength_1" name="description_en" class="form-control"
                                                type="text" maxlength="25" value="{{ $new->description_en }}"
                                                id="example-text-input" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input id="kt_maxlength_1" name="description_gr" class="form-control"
                                                type="text" maxlength="25" value="{{ $new->description_gr }}"
                                                id="example-text-input" />
                                        </div>
                                    </div>
