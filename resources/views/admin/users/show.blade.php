                    ...
                    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Button-->
                                <a href="custom/apps/projects/add-project.html"
                                    class="btn btn-light-primary font-weight-bold ml-2">Edit Project</a>
                                <!--end::Button-->
                                <!--begin::Dropdown-->
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    ...
                                                    <div class="d-flex flex-wrap my-2">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                                ...
                                                                <!--end::Svg Icon-->
                                                            </span>@if($user->status == 0) Normal User
                                                            @elseif($user->status == 1) Owner User @else Tenant User
                                                            @endif </a>
                                                        <a href="#"
                                                ...
                                                <div class="my-lg-0 my-1">
                                                    ...
                                                    <form style="display: inline;"
                                                        action="{{route('binding.accept', $user->id)}}" method="POST">
                                                        @csrf
                                                        @method('put')
                                                        <button
                                                            class="btn btn-sm btn-light-success font-weight-bolder text-uppercase mr-3">Accept</button>
                                                    </form>

                                                    <form style="display: inline;"
                                                        action="{{ route('binding.refuse', $user->id) }}" method="POST">
                                                        @csrf
                                                        @method('put')
                                                        <button
                                                            class="btn btn-sm btn-info font-weight-bolder text-uppercase">Refuse</button>
                                                    </form>
                                                    @endif
                                                </div>
                                            </div>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">Bradly
                                                                    Beal</span>
                                                                <span
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">Chris
                                                                    Thompson</span>
                                                                <span class="text-muted font-weight-bold">NBA
                                                                    Player</span>
                                                            </td>
                                                            <td>
                                                                <span
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">Zoey
                                                                    McGee</span>
                                                                <span class="text-muted font-weight-bold">Ruby
                                                                    Developer</span>
                                                            </td>
                                                            <td>
                                                                <span
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">Brandon
                                                                    Ingram</span>
                                                                <span class="text-muted font-weight-bold">NBA
                                                                    Player</span>
                                                            </td>
                                        ...
                                        <div class="card-header h-auto border-0">
                                            ...
                                            <div class="card-title py-5">
                                                <h3 class="card-label">
                                                    <span class="d-block text-dark font-weight-bolder">Recent
                                                        Stats</span>
                                                    <span class="d-block text-muted mt-2 font-size-sm">More than 400+
                                                        new members</span>
                                                </h3>
                                            </div>
                                            <!--end::Title-->
