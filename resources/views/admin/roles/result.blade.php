                                ...
                                <div class="mb-7">
                                    <div class="row align-items-center">
                                        <div class="col-lg-9 col-xl-8">
                                            <form action="{{ route('roles.results') }}" method="GET" class="row align-items-start">
                                        ...
                                        <div class="col-lg-3 col-xl-4 mt-5 mt-lg-0">
                                            {{ $roles->count() }} elements of communities
                                        </div>
                                    </div>
                                </div>
                                <!--begin::Table-->
                                    ...
                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pl-0">
                                                    <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$role->id}}</a>
                                                </td>

                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$role->name}}</span>
