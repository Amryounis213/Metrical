                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="{{ route('link-user-role.store')}}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <select name="user_id" class="form-control selectpicker" data-size="7"
                                                ...
                                                <span class="form-text text-muted">you can select any user </span>
                                            </div>
                                        </div>
