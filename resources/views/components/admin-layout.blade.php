	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading ">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			...
			<a href="{{route('dashboard')}}">
				<img alt="Logo" src="{{asset('admin/assets/media/logos/Metrical.png')}}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
                 ...
                 <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <a href="{{route('dashboard')}}" class="brand-logo">
                            ...
                            <img alt="Logo" src="{{asset('admin/assets/media/logos/Metrical2.png')}}" class="max-h-50px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Toggle-->
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item " aria-haspopup="true">
                                    <a href="{{route('socials.index')}}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
								...
								<li class="menu-section">
                                    <h4 class="menu-text">Security</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Rules & Permessions</span>
                                    ...
                                    <div class="menu-submenu">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            @can('roles.create')
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="{{route('roles.create')}}" class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">Make New Rule</span>
                                                    
                                                </a>
                                                
                                            </li>
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="{{route('link-user-role')}}" class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">Link User with Rule</span>
                                            ...
                                            @can('admin.create')
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="{{route('admins.create')}}" class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="{{route('admins.index')}}" class="menu-link menu-toggle">
                                                    ...
                                                    <span class="menu-text">Show Admins</span>
                                ...
                                <li class="menu-section">
                                    <h4 class="menu-text">Metrical Sections</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('addnewuserform') }}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ route('tenants.users') }}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ route('binding.users') }}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ route('viewImportUser') }}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                    ...
                                                    <ul class="menu-subnav">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{route('properties.index')}}"
                                                                ...
                                                                <span class="menu-text">Show Properties</span>
                                                            </a>
                                                        </li>
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('offer-type' , 'sale')}}"
                                                            ...
                                                            <span class="menu-text">Sale Offers</span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('offer-type' , 'rent')}}"
                                                            ...
                                                            <span class="menu-text">Rent Offers</span>
                                                        </a>
                                                    </li>
                                             ...
                                             <ul class="menu-subnav">
                                                 <li class="menu-item" aria-haspopup="true">
                                                     <a href="{{route('communities.index')}}"
                                                         ...
                                                         <span class="menu-text">Show Communities</span>
                                                     </a>
                                                 </li>
                                                 <li class="menu-item" aria-haspopup="true">
                                                     <a href="{{route('communities.create')}}"
                                                         ...
                                                         <span class="menu-text">Add Community</span>
                                                     </a>
                                                 </li>
									...
									<ul class="menu-nav">
										<li class="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
											<a href="#" class="menu-link menu-toggle">
                                                ...
                                                <span class="svg-icon svg-icon-warning svg-icon-2x m-2 "><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Group.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon points="0 0 24 0 24 24 0 24"/>
												...
												<span class="menu-text text-light ml-4">
                                                    Pending Users( 
                                                ...
                                                <a href="{{route('offer-type' , 'stop')}}">
                                                <span class="svg-icon svg-icon-warning svg-icon-2x m-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Folder-check.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
												...
												<span class="menu-text text-light ml-2">
                                                    Pending Offers( 
                                                    {{ App\Models\Offer::where('status' ,'!=', '1')->count() }} )
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">METRICAL Dashboard</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
